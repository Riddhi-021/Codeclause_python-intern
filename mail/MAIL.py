...
labelemail = Label(root,text="Email Account", justify = LEFT, bg = "grey", font = "Verdana 10 bold")
...
labelpassword = Label(root , text="Password", justify = LEFT, padx = 10, bg = "grey", font = "Verdana 10 bold")
labelpassword.grid(row=1 , column=0)

password_entry = Entry(root , textvariable=password, width = 30, font=large_font, show = '*')
password_entry.grid(row=1 , column=1)

Label(root, text = "================PLEASE LOGIN FIRST==================", bg = "blue", font = "Verdana 10 bold").grid(row = 2, column = 0, columnspan = 2,padx = 10, pady = 10)

label1 = Label(root, text = "To", justify = LEFT, padx = 30, bg = "grey", font = "Verdana 10 bold")
label1.grid(row = 3, column = 0)

receiver_entry = Entry(root,  width = 30, font=large_font, textvariable = receiver)
receiver_entry.grid(row = 3, column = 1)

label2 = Label(root, text = "Subject", justify = LEFT, padx = 10, bg = "grey", font = "Verdana 10 bold")
